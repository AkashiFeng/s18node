...
var (
	...
	allToolsArchiveFiles = []string{
		"COPYING",
		executablePath("sl8_abigen"),
		executablePath("sl8_bootnode"),
		executablePath("sl8_evm"),
		executablePath("sl8node"),
		executablePath("sl8_puppeth"),
		executablePath("sl8_rlpdump"),
		executablePath("sl8_swarm"),
		executablePath("sl8_wnode"),
	}
	...
	debExecutables = []debExecutable{
		{
			Name:        "sl8_abigen",
			Description: "Source code generator to convert Clean State Shill contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "sl8_bootnode",
		...
		{
			Name:        "sl8node",
			Description: "Clean State Shill CLI client.",
		},
		{
			Name:        "sl8_puppeth",
			Description: "Clean State Shill private network manager.",
		},
		{
			Name:        "sl8_rlpdump",
		...
		{
			Name:        "sl8_swarm",
			Description: "Clean State Shill Swarm daemon and tools",
		},
		{
			Name:        "sl8_wnode",
			Description: "Clean State Shill Whisper diagnostic tool",
		},
	}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/AkashiFeng/s18node/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/AkashiFeng/s18node/mobile")
