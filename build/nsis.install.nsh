...
!define HELPURL "https://github.com/AkashiFeng/s18node/issues"
!define UPDATEURL "https://github.com/AkashiFeng/s18node/releases"
!define ABOUTURL "https://github.com/AkashiFeng/s18node#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30403)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30403)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30403)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30403)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30403 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30403)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30403 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30403)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30403 "" ""
